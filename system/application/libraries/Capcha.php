...
{	
	...
	public function phpcaptcha($textColor,$backgroundColor,$imgWidth,$imgHeight,$noiceLines=0,$noiceDots=500,$noiceColor='#000')
	{	
		/* Settings */
		$text=$this->random();
		$font = 'assets/fonts/font16.ttf';/* font */
		$textColor=$this->hexToRGB($textColor);	
		...
		/*setcookie('captcha_code', $text, time() + (86400 * 30), "/"); */
		 if(isset($_SESSION))
		{
	...
	/*for random string*/
	protected function random($characters=4,$letters = '23456789'){
		$str='';
